...
# SWE-agent — AKIL3333 Edition

> A presentation-refreshed distribution of SWE-agent. The implementation, CLI behavior, and research workflows are unchanged.
...
Please use [SWE-agent 0.7](https://github.com/AKIL3333/akil-swe-agent/tree/v0.7) while we update EnIGMA for 1.0.
...
<div align="center">
  ...
  &nbsp;&nbsp;
  <!-- <a href="https://github.com/AKIL3333/akil-swe-agent"><img src="docs/assets/sweagent_logo_text_below.svg" alt="SWE-agent" height="120px"></a> -->
...
If you'd like to contribute to the codebase, we welcome [issues](https://github.com/AKIL3333/akil-swe-agent/issues) and [pull requests](https://github.com/AKIL3333/akil-swe-agent/pulls)! For larger code changes, we always encourage discussion in issues first.
...
Maintained by **AKIL3333**. Upstream attribution is retained in the citation and license sections.
...
[![Pytest](https://github.com/AKIL3333/akil-swe-agent/actions/workflows/pytest.yaml/badge.svg)](https://github.com/AKIL3333/akil-swe-agent/actions/workflows/pytest.yaml)
[![build-docs](https://github.com/AKIL3333/akil-swe-agent/actions/workflows/build-docs.yaml/badge.svg)](https://github.com/AKIL3333/akil-swe-agent/actions/workflows/build-docs.yaml)
...
[![Markdown links](https://github.com/AKIL3333/akil-swe-agent/actions/workflows/check-links-periodic.yaml/badge.svg)](https://github.com/AKIL3333/akil-swe-agent/actions/workflows/check-links-periodic.yaml)
